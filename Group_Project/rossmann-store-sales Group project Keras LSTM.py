...
train = pd.read_csv('C:/Users/840-G2/Downloads/rossmann-store-sales/train.csv', low_memory = False)
store = pd.read_csv('C:/Users/840-G2/Downloads/rossmann-store-sales/store.csv', low_memory = False)
test = pd.read_csv('C:/Users/840-G2/Downloads/rossmann-store-sales/test.csv', low_memory = False)
...
B_array = np.asarray(X_test,dtype='float')
A_array = np.asarray(Y_test,dtype='float')
...
# print(model.summary())
model.fit(np.asarray(X_array), np.asarray(Y_array), epochs=100)

print(model.predict_classes(np.asarray(X_array)))
"""
